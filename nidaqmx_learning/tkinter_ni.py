...
File Name: tkinter_ni.py
Author: Liu Ming
Created Time: February 27th, 2025
Description: This script creates a Tkinter-based GUI application for continuously acquiring voltage input using NI-DAQmx. The application allows users to configure channel settings, input settings, and visualize the acquired data in real-time using Matplotlib.
Preparation:
...
Run Instructions:
1. Execute the script using Python: `python tkinter_ni.py`
...
class channelSettings(tk.LabelFrame):
    ...
    def create_widgets(self):
        ...
        self.physicalChannelEntry.insert(0, "cDAQ9189-1D712C2Mod1/ai0")
