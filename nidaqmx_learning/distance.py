...
class SimpleModelingApp:
    def __init__(self, root):
        ...
        # Data storage
        self.model_data = None  # Store imported model vertices and faces
        self.points_data = []   # [(x1, y1, z1), (x2, y2, z2), (x3, y3, z3)]
        self.distances = [None, None, None]  # Distances for each point
    ...
    def setup_gui(self):
        ...
        self.export_path.insert(0, "exported_model.stl")  # Default export path
    ...
    def import_model(self):
        ...
        try:
            ...
            vertices = model.vectors.reshape(-1, 3)  # Vertices
            faces = np.arange(len(vertices)).reshape(-1, 3)  # Simple face indices
    ...
    def redraw_scene(self):
        ...
        # Set axis limits (considering zoom)
        all_x, all_y, all_z = [], [], []
        if self.model_data:
    ...
    def zoom_in(self):
        """Zoom in"""
        self.zoom_level *= 1.1  # Zoom in by 10%
        self.adjust_zoom()

    def zoom_out(self):
        """Zoom out"""
        self.zoom_level /= 1.1  # Zoom out by 10%
        self.adjust_zoom()

    def adjust_zoom(self):
        """Adjust axis limits based on zoom level"""
    ...
    # **New: Export model method**
    def export_model(self):
        """Export the current model to an STL file"""
